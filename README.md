...
Follow these steps in order whenever you commit and release a new version.
...
Tag names follow `MAJOR.MINOR.PATCH` (no `v` prefix). The annotation message
always points to `CHANGELOG.md` for details:
